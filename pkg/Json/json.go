...
func (Json) WriteJSONiter(w http.ResponseWriter, status int, data any, headers http.Header) error {
...
func (Json) ReadJSONiter(w http.ResponseWriter, r *http.Request, dst any) error {
	maxBytes := 1_048_576
	r.Body = http.MaxBytesReader(w, r.Body, int64(maxBytes))
